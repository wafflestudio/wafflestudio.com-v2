...
const UsingTypescript: React.FC<PageProps<DataProps>> = ({ data, path }) => (
  <Layout>
    ...
    <p>
      This means that you can create and write <em>.ts/.tsx</em> files for your pages, components etc. Please note that the{' '}
      <em>gatsby-*.js</em> files (like gatsby-node.js) currently don&quot;t support TypeScript yet.
    </p>
    <p>
